...
Notas musicais é um CLI para ajudar na formação de escalas, acordes e campos harmônicas

Toda a aplicação é baseada em um comando chamado `notas-musicais`. Esse comando tem um subcomando relacionado a cada 
ação que a aplicação pode realizar. Como `escalas`, `acordes` e `campo-harmonico`
